...
<form class="pkp_form" id="creditSettingsForm" method="post" action="{url router=$smarty.const.ROUTE_COMPONENT op="manage" plugin="creditplugin" category="generic" verb="save"}">
	{csrf}
